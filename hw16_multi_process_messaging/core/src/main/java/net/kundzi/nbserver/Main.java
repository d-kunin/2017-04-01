...
import net.kundzi.nbserver.message.lvmessage.DefaultLvMessage;
...
public class Main {
  ...
  private static void nonblockingServer() throws IOException, InterruptedException {
    ...
    final SimpleReactorServer.IncomingMessageHandler<LvMessage> handler = (from, message) -> {
