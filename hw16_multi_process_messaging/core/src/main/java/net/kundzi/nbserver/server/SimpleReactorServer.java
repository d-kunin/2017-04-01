package net.kundzi.nbserver.server;

import com.google.common.util.concurrent.ThreadFactoryBuilder;
import net.kundzi.nbserver.message.MessageReader;
import net.kundzi.nbserver.util.Io;
...
public class SimpleReactorServer<M extends Message> implements Closeable {
  ...
  public void stop() {
    ...
    Io.closeExecutorService(inMessagesExecutor);
    Io.closeExecutorService(outMessagesExecutor);
    Io.closeExecutorService(selectExecutor);
    Io.closeExecutorService(reaperExecutor);
    try {
      selector.close();
    } catch (IOException e) {
